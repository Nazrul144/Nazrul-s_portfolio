    ...
    return (
        <div>
            <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
                ...
                <div>
                    <h1 className="font-semibold">Crafting seamless digital experiences with expertise in responsive web design and intuitive UI/UX principles. <br /> Let's transform ideas into visually stunning and functional websites together. Thank you.</h1>
                </div>
                <nav>
